...
export default function AdminNotificacionesPage() {
  ...
  const fetchNotifications = () => {
    fetch(`${process.env.API_URL}api/admin/notificaciones`, {
      headers: {
  ...
  const markAsRead = (notificationId: number, url: string) => {
    fetch(
      `${process.env.API_URL}api/admin/notificaciones/${notificationId}/read`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${getCookie("token")}`,
  ...
  const markAllAsRead = () => {
    fetch(`${process.env.API_URL}api/admin/notificaciones/mark-all-read`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${getCookie("token")}`,
        Accept: "application/json",
